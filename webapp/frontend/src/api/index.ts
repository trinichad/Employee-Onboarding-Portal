...
export const adminApi = {
  ...
  updateSettings: (data: Partial<{ platform_name: string; default_support_email: string; default_from_email: string; default_from_name: string; default_dashboard_columns: string[]; timezone: string; public_base_url: string; backend_port: number; frontend_port: number }> & SmtpConfigUpdate) =>
